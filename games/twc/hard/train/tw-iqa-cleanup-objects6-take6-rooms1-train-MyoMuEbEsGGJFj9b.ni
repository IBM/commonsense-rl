...
The corridor part 0 is some text that varies. The corridor part 0 is "You arrive in a corridor. A normal one.
 ...
 You smell an interesting smell, and follow it to a shoe cabinet. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_0 is open and there is something in the c_0] The shoe cabinet contains [a list of things in the c_0]. You wonder idly who left that here.[end if]".
The corridor part 1 is some text that varies. The corridor part 1 is "[if c_0 is open and the c_0 contains nothing] The shoe cabinet is empty! What a waste of a day![end if]".
The corridor part 2 is some text that varies. The corridor part 2 is " Oh, great. Here's a coat hanger. [if there is something on the s_0]On the coat hanger you make out [a list of things on the s_0].[end if]".
The corridor part 3 is some text that varies. The corridor part 3 is "[if there is nothing on the s_0]The coat hanger appears to be empty.[end if]".
The corridor part 4 is some text that varies. The corridor part 4 is " You make out an umbrella stand. [if there is something on the s_1]On the umbrella stand you can make out [a list of things on the s_1], so there's that.[end if]".
The corridor part 5 is some text that varies. The corridor part 5 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though.[end if]".
The corridor part 6 is some text that varies. The corridor part 6 is " You make out a key holder. The key holder is usual.[if there is something on the s_2] On the key holder you can see [a list of things on the s_2].[end if]".
The corridor part 7 is some text that varies. The corridor part 7 is "[if there is nothing on the s_2] But oh no! there's nothing on this piece of trash.[end if]".
The corridor part 8 is some text that varies. The corridor part 8 is " You rest your hand against a wall, but you miss the wall and fall onto a hat rack. The hat rack is standard.[if there is something on the s_3] On the hat rack you can see [a list of things on the s_3].[end if]".
The corridor part 9 is some text that varies. The corridor part 9 is "[if there is nothing on the s_3] But the thing hasn't got anything on it.[end if]".
...
The c_0 is in r_0.
The c_0 is open.
The description of o_0 is "The [noun] appears to be well matched to everything else here".
The printed name of o_0 is "court shoes".
The indefinite article of o_0 is "a pair of".
Understand "court shoes" as o_0.
Understand "court" as o_0.
Understand "shoes" as o_0.
The o_0 is in r_0.
The description of o_2 is "The [noun] appears to be out of place here".
The printed name of o_2 is "blue business shoes".
The indefinite article of o_2 is "a pair of".
Understand "blue business shoes" as o_2.
Understand "blue" as o_2.
Understand "business" as o_2.
Understand "shoes" as o_2.
The o_2 is in r_0.
The description of o_3 is "The [noun] would seem to be out of place here".
The printed name of o_3 is "running shoes".
The indefinite article of o_3 is "a pair of".
Understand "running shoes" as o_3.
Understand "running" as o_3.
Understand "shoes" as o_3.
The o_3 is in r_0.
The description of o_4 is "The [noun] appears to be well matched to everything else here".
The printed name of o_4 is "derby hat".
Understand "derby hat" as o_4.
Understand "derby" as o_4.
Understand "hat" as o_4.
The o_4 is in r_0.
The description of s_0 is "The [noun] is undependable.".
The printed name of s_0 is "coat hanger".
Understand "coat hanger" as s_0.
Understand "coat" as s_0.
Understand "hanger" as s_0.
The s_0 is in r_0.
The description of s_1 is "The [noun] is undependable.".
The printed name of s_1 is "umbrella stand".
Understand "umbrella stand" as s_1.
Understand "umbrella" as s_1.
...
The printed name of s_3 is "hat rack".
Understand "hat rack" as s_3.
Understand "hat" as s_3.
...
The printed name of o_1 is "gray cap".
Understand "gray cap" as o_1.
Understand "gray" as o_1.
Understand "cap" as o_1.
The o_1 is in the c_0.
The description of o_5 is "The [noun] is cheap looking.".
The printed name of o_5 is "brown cap".
Understand "brown cap" as o_5.
Understand "brown" as o_5.
Understand "cap" as o_5.
