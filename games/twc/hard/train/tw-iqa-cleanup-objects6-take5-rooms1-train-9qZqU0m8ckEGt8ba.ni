...
The pantry part 0 is some text that varies. The pantry part 0 is "Look at you, bigshot, walking into a pantry like it isn't some huge deal. You begin looking for stuff.

 You make out a folding chair. [if there is something on the s_0]You see [a list of things on the s_0] on the folding chair.[end if]".
...
The pantry part 2 is some text that varies. The pantry part 2 is " You bend down to tie your shoe. When you stand up, you notice a shelf. Now why would someone leave that there? The shelf is wooden.[if there is something on the s_1] On the shelf you can make out [a list of things on the s_1]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
