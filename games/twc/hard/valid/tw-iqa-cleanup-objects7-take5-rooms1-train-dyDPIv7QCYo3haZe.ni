...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A typical kind of place. Let's see what's in here.

 Were you looking for a BBQ? Because look over there, it's a BBQ. The BBQ is recent.[if there is something on the s_0] On the BBQ you can see [a list of things on the s_0]. A BBQ... Is that really what you were looking for?[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " Oh wow! Is that what I think it is? It is! It's a clothesline. [if there is something on the s_1]You see [a list of things on the s_1] on the clothesline. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_1]But the thing hasn't got anything on it.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. The patio table is stylish.[if there is something on the s_2] On the patio table you make out [a list of things on the s_2].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_2] However, the patio table, like an empty patio table, has nothing on it.[end if]".
The backyard part 6 is some text that varies. The backyard part 6 is " You see a patio chair. Now why would someone leave that there? The patio chair is stylish.[if there is something on the s_3] On the patio chair you make out [a list of things on the s_3].[end if]".
The backyard part 7 is some text that varies. The backyard part 7 is "[if there is nothing on the s_3] But the thing hasn't got anything on it. Oh! Why couldn't there just be stuff on it?[end if]".
The backyard part 8 is some text that varies. The backyard part 8 is " You see a gleam over in a corner, where you can see a workbench. The workbench is wooden.[if there is something on the s_4] On the workbench you see [a list of things on the s_4].[end if]".
The backyard part 9 is some text that varies. The backyard part 9 is "[if there is nothing on the s_4] But the thing hasn't got anything on it.[end if]".
The backyard part 10 is some text that varies. The backyard part 10 is "

".
The description of r_0 is "[backyard part 0][backyard part 1][backyard part 2][backyard part 3][backyard part 4][backyard part 5][backyard part 6][backyard part 7][backyard part 8][backyard part 9][backyard part 10]".


The o_0 and the o_4 and the o_3 and the o_6 and the o_1 and the o_2 and the o_5 are object-likes.
The o_0 and the o_4 and the o_3 and the o_6 and the o_1 and the o_2 and the o_5 are privately-named.
The r_0 are rooms.
...
The printed name of o_0 is "wet striped blazer".
Understand "wet striped blazer" as o_0.
Understand "wet" as o_0.
Understand "striped" as o_0.
Understand "blazer" as o_0.
The o_0 is in r_0.
The description of o_4 is "The [noun] looks to fit in here".
The printed name of o_4 is "wet plaid blazer".
Understand "wet plaid blazer" as o_4.
Understand "wet" as o_4.
Understand "plaid" as o_4.
Understand "blazer" as o_4.
The o_4 is in r_0.
...
The printed name of s_2 is "patio table".
Understand "patio table" as s_2.
Understand "patio" as s_2.
...
The printed name of o_3 is "wet green T-shirt".
Understand "wet green T-shirt" as o_3.
Understand "wet" as o_3.
Understand "green" as o_3.
Understand "T-shirt" as o_3.
The player carries the o_3.
The description of o_6 is "The [noun] is expensive looking.".
The printed name of o_6 is "wet shorts".
The indefinite article of o_6 is "a pair of".
Understand "wet shorts" as o_6.
Understand "wet" as o_6.
Understand "shorts" as o_6.
The player carries the o_6.
The description of o_1 is "The [noun] is antiquated.".
The printed name of o_1 is "wet black shirt".
Understand "wet black shirt" as o_1.
Understand "wet" as o_1.
Understand "black" as o_1.
Understand "shirt" as o_1.
The o_1 is on the s_2.
The description of o_2 is "The [noun] appears to be to fit in here".
The printed name of o_2 is "wet cardigan".
Understand "wet cardigan" as o_2.
Understand "wet" as o_2.
Understand "cardigan" as o_2.
The o_2 is on the s_4.
The description of o_5 is "The [noun] is brand new.".
The printed name of o_5 is "wet gray dress".
Understand "wet gray dress" as o_5.
Understand "wet" as o_5.
Understand "gray" as o_5.
