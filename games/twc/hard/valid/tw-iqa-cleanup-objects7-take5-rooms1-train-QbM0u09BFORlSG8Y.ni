...
The pantry part 0 is some text that varies. The pantry part 0 is "Well, here we are in the pantry.
 ...
 You can make out a folding chair. The folding chair is wooden.[if there is something on the s_0] On the folding chair you can see [a list of things on the s_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The pantry part 2 is some text that varies. The pantry part 2 is " You can make out a shelf. [if there is something on the s_1]On the shelf you make out [a list of things on the s_1]. Classic TextWorld.[end if]".
The pantry part 3 is some text that varies. The pantry part 3 is "[if there is nothing on the s_1]But there isn't a thing on it.[end if]".
...
The f_4 and the f_5 and the f_0 and the f_1 and the f_2 and the f_3 and the f_6 are foods.
The f_4 and the f_5 and the f_0 and the f_1 and the f_2 and the f_3 and the f_6 are privately-named.
The r_0 are rooms.
...
The printed name of s_0 is "folding chair".
Understand "folding chair" as s_0.
Understand "folding" as s_0.
