...
The laundry room part 0 is some text that varies. The laundry room part 0 is "You arrive in a laundry room. A normal one.

 You can make out a washing machine. You wonder idly who left that here.[if c_0 is open and there is something in the c_0] The washing machine contains [a list of things in the c_0].[end if]".
The laundry room part 1 is some text that varies. The laundry room part 1 is "[if c_0 is open and the c_0 contains nothing] The washing machine is empty! This is the worst thing that could possibly happen, ever![end if]".
The laundry room part 2 is some text that varies. The laundry room part 2 is " You see a laundry basket.[if c_1 is open and there is something in the c_1] The laundry basket contains [a list of things in the c_1].[end if]".
The laundry room part 3 is some text that varies. The laundry room part 3 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The laundry basket is empty![end if]".
The laundry room part 4 is some text that varies. The laundry room part 4 is " Look out! It's a- oh, never mind, it's just a clothes drier. Something scurries by right in the corner of your eye. Probably nothing.[if c_2 is open and there is something in the c_2] The clothes drier contains [a list of things in the c_2].[end if]".
The laundry room part 5 is some text that varies. The laundry room part 5 is "[if c_2 is open and the c_2 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
The laundry room part 6 is some text that varies. The laundry room part 6 is " You see a work table. [if there is something on the s_0]On the work table you see [a list of things on the s_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The laundry room part 7 is some text that varies. The laundry room part 7 is "[if there is nothing on the s_0]But there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The laundry room part 8 is some text that varies. The laundry room part 8 is " You see a suspended shelf. The suspended shelf is typical.[if there is something on the s_1] On the suspended shelf you can see [a list of things on the s_1].[end if]".
The laundry room part 9 is some text that varies. The laundry room part 9 is "[if there is nothing on the s_1] Unfortunately, there isn't a thing on it.[end if]".
The laundry room part 10 is some text that varies. The laundry room part 10 is " You can see a bench. The bench is w.[if there is something on the s_2] On the bench you see [a list of things on the s_2].[end if]".
The laundry room part 11 is some text that varies. The laundry room part 11 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it.[end if]".
The laundry room part 12 is some text that varies. The laundry room part 12 is "

".
The description of r_0 is "[laundry room part 0][laundry room part 1][laundry room part 2][laundry room part 3][laundry room part 4][laundry room part 5][laundry room part 6][laundry room part 7][laundry room part 8][laundry room part 9][laundry room part 10][laundry room part 11][laundry room part 12]".


The c_0 and the c_1 and the c_2 are containers.
The c_0 and the c_1 and the c_2 are privately-named.
The o_1 and the o_3 and the o_4 and the o_5 and the o_0 and the o_2 and the o_6 are object-likes.
The o_1 and the o_3 and the o_4 and the o_5 and the o_0 and the o_2 and the o_6 are privately-named.
The r_0 are rooms.
...
The c_1 is in r_0.
The c_1 is open.
The description of c_2 is "The [noun] looks stuffy. [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to bash open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
...
The printed name of o_1 is "dirty brown pullover".
Understand "dirty brown pullover" as o_1.
Understand "dirty" as o_1.
Understand "brown" as o_1.
Understand "pullover" as o_1.
The o_1 is in r_0.
The description of o_3 is "The [noun] is expensive looking.".
The printed name of o_3 is "wet white panties".
The indefinite article of o_3 is "a pair of".
Understand "wet white panties" as o_3.
Understand "wet" as o_3.
Understand "white" as o_3.
Understand "panties" as o_3.
The o_3 is in r_0.
The description of o_4 is "The [noun] would seem to be to fit in here".
The printed name of o_4 is "dirty magenta skirt".
Understand "dirty magenta skirt" as o_4.
Understand "dirty" as o_4.
Understand "magenta" as o_4.
Understand "skirt" as o_4.
The o_4 is in r_0.
The description of o_5 is "The [noun] is dirty.".
The printed name of o_5 is "dirty striped pullover".
Understand "dirty striped pullover" as o_5.
Understand "dirty" as o_5.
Understand "striped" as o_5.
Understand "pullover" as o_5.
The o_5 is in r_0.
The description of s_0 is "The [noun] is durable.".
The printed name of s_0 is "work table".
Understand "work table" as s_0.
Understand "work" as s_0.
Understand "table" as s_0.
The s_0 is in r_0.
The description of s_1 is "The [noun] is unstable.".
The printed name of s_1 is "suspended shelf".
Understand "suspended shelf" as s_1.
Understand "suspended" as s_1.
...
The printed name of o_0 is "wet plaid socks".
The indefinite article of o_0 is "a pair of".
Understand "wet plaid socks" as o_0.
Understand "wet" as o_0.
Understand "plaid" as o_0.
Understand "socks" as o_0.
The o_0 is on the s_1.
The description of o_2 is "The [noun] is unremarkable.".
The printed name of o_2 is "dirty striped polo shirt".
Understand "dirty striped polo shirt" as o_2.
Understand "dirty" as o_2.
Understand "striped" as o_2.
Understand "polo" as o_2.
Understand "shirt" as o_2.
The o_2 is on the s_1.
The description of o_6 is "The [noun] looks to fit in here".
The printed name of o_6 is "wet blue jumper".
Understand "wet blue jumper" as o_6.
Understand "wet" as o_6.
Understand "blue" as o_6.
Understand "jumper" as o_6.
