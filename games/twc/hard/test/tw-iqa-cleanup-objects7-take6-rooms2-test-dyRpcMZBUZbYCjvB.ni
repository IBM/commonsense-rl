...
The bedroom part 1 is some text that varies. The bedroom part 1 is " wardrobe.[if c_0 is open and there is something in the c_0] The wardrobe contains [a list of things in the c_0].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " chest of drawers.[if c_1 is open and there is something in the c_1] The chest of drawers contains [a list of things in the c_1], so there's that.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The chest of drawers is empty![end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " Look out! It's a- oh, never mind, it's just a bed. The bed is large.[if there is something on the s_0] On the bed you see [a list of things on the s_0].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0] But there isn't a thing on it. It would have been so cool if there was stuff on the bed.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "Look at you, bigshot, walking into a livingroom like it isn't some huge deal.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bookcase.[if c_2 is open and there is something in the c_2] The bookcase contains [a list of things in the c_2].[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if c_2 is open and the c_2 contains nothing] The bookcase is empty! What a waste of a day![end if]".
The livingroom part 2 is some text that varies. The livingroom part 2 is " You make out a sofa. The sofa is comfy.[if there is something on the s_1] On the sofa you can make out [a list of things on the s_1]. Classic TextWorld.[end if]".
The livingroom part 3 is some text that varies. The livingroom part 3 is "[if there is nothing on the s_1] But the thing is empty, unfortunately.[end if]".
The livingroom part 4 is some text that varies. The livingroom part 4 is " You make out a coffee table. [if there is something on the s_2]You see [a list of things on the s_2] on the coffee table.[end if]".
The livingroom part 5 is some text that varies. The livingroom part 5 is "[if there is nothing on the s_2]The coffee table appears to be empty.[end if]".
The livingroom part 6 is some text that varies. The livingroom part 6 is " You see an armchair. The armchair is comfortable.[if there is something on the s_3] On the armchair you see [a list of things on the s_3].[end if]".
The livingroom part 7 is some text that varies. The livingroom part 7 is "[if there is nothing on the s_3] The armchair appears to be empty. Hopefully this doesn't make you too upset.[end if]".
...
The o_1 and the o_0 and the o_2 and the o_5 and the o_3 and the o_4 and the o_6 are object-likes.
The o_1 and the o_0 and the o_2 and the o_5 and the o_3 and the o_4 and the o_6 are privately-named.
The r_0 and the r_1 are rooms.
...
The c_1 is in r_0.
The c_1 is open.
The description of c_2 is "The [noun] looks imposing. [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to break open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
The printed name of c_2 is "bookcase".
Understand "bookcase" as c_2.
The c_2 is in r_1.
The c_2 is open.
The description of o_1 is "The [noun] looks out of place here".
The printed name of o_1 is "clean gray polo shirt".
Understand "clean gray polo shirt" as o_1.
Understand "clean" as o_1.
Understand "gray" as o_1.
Understand "polo" as o_1.
...
The printed name of s_2 is "coffee table".
Understand "coffee table" as s_2.
Understand "coffee" as s_2.
...
The printed name of o_0 is "brown suit".
Understand "brown suit" as o_0.
Understand "brown" as o_0.
Understand "suit" as o_0.
The o_0 is in the c_1.
The description of o_2 is "The [noun] would seem to be to fit in here".
The printed name of o_2 is "blue coat".
Understand "blue coat" as o_2.
Understand "blue" as o_2.
Understand "coat" as o_2.
The o_2 is in the c_1.
The description of o_5 is "The [noun] appears out of place here".
The printed name of o_5 is "clean white pullover".
Understand "clean white pullover" as o_5.
...
The printed name of o_3 is "black coat".
Understand "black coat" as o_3.
Understand "black" as o_3.
Understand "coat" as o_3.
The o_3 is on the s_1.
The description of o_4 is "The [noun] looks out of place here".
The printed name of o_4 is "brown coat".
Understand "brown coat" as o_4.
Understand "brown" as o_4.
Understand "coat" as o_4.
The o_4 is on the s_3.
The description of o_6 is "The [noun] seems out of place here".
The printed name of o_6 is "clean teal skirt".
Understand "clean teal skirt" as o_6.
Understand "clean" as o_6.
Understand "teal" as o_6.
Understand "skirt" as o_6.
