...
The pantry part 0 is some text that varies. The pantry part 0 is "You're not going to believe this, but you've just entered a pantry.
 ...
 You can make out a folding chair. The folding chair is wooden.[if there is something on the s_0] On the folding chair you can see [a list of things on the s_0], so there's that.[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of junk.[end if]".
The pantry part 2 is some text that varies. The pantry part 2 is " Were you looking for a shelf? Because look over there, it's a shelf. The shelf is wooden.[if there is something on the s_1] On the shelf you make out [a list of things on the s_1].[end if]".
The pantry part 3 is some text that varies. The pantry part 3 is "[if there is nothing on the s_1] But the thing is empty, unfortunately.[end if]".
