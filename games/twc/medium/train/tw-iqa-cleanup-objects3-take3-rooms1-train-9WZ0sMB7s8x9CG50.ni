...
The corridor part 0 is some text that varies. The corridor part 0 is "You're now in the corridor.
 ...
 You see a shoe cabinet.[if c_0 is open and there is something in the c_0] The shoe cabinet contains [a list of things in the c_0].[end if]".
...
The corridor part 2 is some text that varies. The corridor part 2 is " You see an umbrella stand. The umbrella stand is standard.[if there is something on the s_0] On the umbrella stand you can see [a list of things on the s_0].[end if]".
The corridor part 3 is some text that varies. The corridor part 3 is "[if there is nothing on the s_0] Unfortunately, there isn't a thing on it.[end if]".
The corridor part 4 is some text that varies. The corridor part 4 is " You see a coat hanger. The coat hanger is usual.[if there is something on the s_1] On the coat hanger you can see [a list of things on the s_1]. Classic TextWorld.[end if]".
...
The corridor part 6 is some text that varies. The corridor part 6 is " You see a hat rack. [if there is something on the s_2]You see [a list of things on the s_2] on the hat rack.[end if]".
The corridor part 7 is some text that varies. The corridor part 7 is "[if there is nothing on the s_2]But the thing is empty. Oh! Why couldn't there just be stuff on it?[end if]".
The corridor part 8 is some text that varies. The corridor part 8 is " Oh, great. Here's a key holder. [if there is something on the s_3]On the key holder you can see [a list of things on the s_3].[end if]".
...
The printed name of o_0 is "climbing shoes".
The indefinite article of o_0 is "a pair of".
Understand "climbing shoes" as o_0.
Understand "climbing" as o_0.
...
The printed name of o_2 is "white cap".
Understand "white cap" as o_2.
Understand "white" as o_2.
Understand "cap" as o_2.
The o_2 is in r_0.
