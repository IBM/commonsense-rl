...
The pantry part 0 is some text that varies. The pantry part 0 is "You find yourself in a pantry. An ordinary kind of place.
 ...
 Look out! It's a- oh, never mind, it's just a shelf. I guess it's true what they say, if you're looking for a shelf, go to TextWorld. [if there is something on the s_0]You see [a list of things on the s_0] on the shelf. Now that's what I call TextWorld![end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of junk. Oh! Why couldn't there just be stuff on it?[end if]".
The pantry part 2 is some text that varies. The pantry part 2 is " Hey, want to see a folding chair? Look over there, a folding chair. The folding chair is wooden.[if there is something on the s_1] On the folding chair you make out [a list of things on the s_1].[end if]".
The pantry part 3 is some text that varies. The pantry part 3 is "[if there is nothing on the s_1] However, the folding chair, like an empty folding chair, has nothing on it.[end if]".
...
The printed name of s_1 is "folding chair".
Understand "folding chair" as s_1.
Understand "folding" as s_1.
...
The printed name of f_0 is "black pepper".
The indefinite article of f_0 is "some".
Understand "black pepper" as f_0.
Understand "black" as f_0.
