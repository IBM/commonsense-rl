...
The pantry part 0 is some text that varies. The pantry part 0 is "You find yourself in a pantry. An ordinary one.
 ...
 You can make out a shelf. The shelf is wooden.[if there is something on the s_0] On the shelf you make out [a list of things on the s_0].[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_0] But the thing is empty, unfortunately. Hm. Oh well[end if]".
The pantry part 2 is some text that varies. The pantry part 2 is " You scan the room, seeing a folding chair. The folding chair is wooden.[if there is something on the s_1] On the folding chair you make out [a list of things on the s_1].[end if]".
The pantry part 3 is some text that varies. The pantry part 3 is "[if there is nothing on the s_1] The folding chair appears to be empty. It would have been so cool if there was stuff on the folding chair.[end if]".
