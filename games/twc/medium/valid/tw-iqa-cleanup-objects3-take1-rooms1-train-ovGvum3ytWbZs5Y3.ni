...
The laundry room part 0 is some text that varies. The laundry room part 0 is "Okay, so you're in a laundry room, cool, but is it usual? You better believe it is.

 You can make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The laundry room part 1 is some text that varies. The laundry room part 1 is " washing machine.[if c_0 is open and there is something in the c_0] The washing machine contains [a list of things in the c_0].[end if]".
The laundry room part 2 is some text that varies. The laundry room part 2 is "[if c_0 is open and the c_0 contains nothing] The washing machine is empty, what a horrible day![end if]".
The laundry room part 3 is some text that varies. The laundry room part 3 is " You smell an awful smell, and follow it to a clothes drier. Now that's what I call TextWorld![if c_1 is open and there is something in the c_1] The clothes drier contains [a list of things in the c_1].[end if]".
The laundry room part 4 is some text that varies. The laundry room part 4 is "[if c_1 is open and the c_1 contains nothing] The clothes drier is empty, what a horrible day![end if]".
The laundry room part 5 is some text that varies. The laundry room part 5 is " As if things weren't amazing enough already, you can even see a laundry basket.[if c_2 is open and there is something in the c_2] The laundry basket contains [a list of things in the c_2].[end if]".
The laundry room part 6 is some text that varies. The laundry room part 6 is "[if c_2 is open and the c_2 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
The laundry room part 7 is some text that varies. The laundry room part 7 is " You see a suspended shelf. [if there is something on the s_0]On the suspended shelf you make out [a list of things on the s_0]. It doesn't get more TextWorld than this![end if]".
The laundry room part 8 is some text that varies. The laundry room part 8 is "[if there is nothing on the s_0]But the thing is empty, unfortunately.[end if]".
The laundry room part 9 is some text that varies. The laundry room part 9 is " You can see a bench. [if there is something on the s_1]You see [a list of things on the s_1] on the bench.[end if]".
The laundry room part 10 is some text that varies. The laundry room part 10 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it.[end if]".
The laundry room part 11 is some text that varies. The laundry room part 11 is " You see a work table. [if there is something on the s_2]On the work table you can see [a list of things on the s_2]. It doesn't get more TextWorld than this![end if]".
The laundry room part 12 is some text that varies. The laundry room part 12 is "[if there is nothing on the s_2]But there isn't a thing on it. Silly work table, silly, empty, good for nothing work table.[end if]".
...
The printed name of o_2 is "dirty long-sleeve top".
Understand "dirty long-sleeve top" as o_2.
Understand "dirty" as o_2.
Understand "long-sleeve" as o_2.
...
The printed name of o_0 is "wet brown blazer".
Understand "wet brown blazer" as o_0.
...
The printed name of o_1 is "wet orange dress".
Understand "wet orange dress" as o_1.
Understand "wet" as o_1.
Understand "orange" as o_1.
