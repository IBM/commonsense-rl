...
The corridor part 2 is some text that varies. The corridor part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a coat hanger. The coat hanger is normal.[if there is something on the s_0] On the coat hanger you see [a list of things on the s_0].[end if]".
...
The corridor part 4 is some text that varies. The corridor part 4 is " You can make out a hat rack. [if there is something on the s_1]You see [a list of things on the s_1] on the hat rack.[end if]".
The corridor part 5 is some text that varies. The corridor part 5 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though. Hm. Oh well[end if]".
The corridor part 6 is some text that varies. The corridor part 6 is " You hear a noise behind you and spin around, but you can't see anything other than an umbrella stand. The umbrella stand is usual.[if there is something on the s_2] On the umbrella stand you can make out [a list of things on the s_2]. You shudder, but continue examining the room.[end if]".
...
The corridor part 8 is some text that varies. The corridor part 8 is " You hear a noise behind you and spin around, but you can't see anything other than a key holder! The key holder is ordinary.[if there is something on the s_3] On the key holder you can make out [a list of things on the s_3]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The corridor part 9 is some text that varies. The corridor part 9 is "[if there is nothing on the s_3] But the thing is empty. It would have been so cool if there was stuff on the key holder.[end if]".
...
The printed name of s_2 is "umbrella stand".
Understand "umbrella stand" as s_2.
Understand "umbrella" as s_2.
