...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. A typical kind of place. Okay, just remember what you're here to do, and everything will go great.

 If you haven't noticed it already, there seems to be something there by the wall, it's a folding chair. [if there is something on the s_0]On the folding chair you see [a list of things on the s_0].[end if]".
...
The pantry part 2 is some text that varies. The pantry part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a shelf. [if there is something on the s_1]On the shelf you can make out [a list of things on the s_1].[end if]".
The pantry part 3 is some text that varies. The pantry part 3 is "[if there is nothing on the s_1]But the thing is empty, unfortunately. This always happens![end if]".
