...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You can see a chest of drawers.[if c_1 is open and there is something in the c_1] The chest of drawers contains [a list of things in the c_1].[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if c_1 is open and the c_1 contains nothing] The chest of drawers is empty, what a horrible day![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " You hear a noise behind you and spin around, but you can't see anything other than a bed. The bed is large.[if there is something on the s_0] On the bed you see [a list of things on the s_0].[end if]".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is " You make out a dark carpet. [if there is something on the s_1]You see [a list of things on the s_1] on the dark carpet.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "[if there is nothing on the s_1]But the thing hasn't got anything on it.[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is " Hey, want to see a desk chair? Look over there, a desk chair. The desk chair is typical.[if there is something on the s_2] On the desk chair you see [a list of things on the s_2].[end if]".
The bedroom part 10 is some text that varies. The bedroom part 10 is "[if there is nothing on the s_2] But the thing is empty. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The bedroom part 11 is some text that varies. The bedroom part 11 is " You see a dressing table. [if there is something on the s_3]You see [a list of things on the s_3] on the dressing table.[end if]".
The bedroom part 12 is some text that varies. The bedroom part 12 is "[if there is nothing on the s_3]But oh no! there's nothing on this piece of trash. You think about smashing the dressing table to bits, throwing the bits into a pit, etc, until you get bored and decide to move on.[end if]".
The bedroom part 13 is some text that varies. The bedroom part 13 is " Look out! It's a- oh, never mind, it's just a desk. [if there is something on the s_4]You see [a list of things on the s_4] on the desk.[end if]".
The bedroom part 14 is some text that varies. The bedroom part 14 is "[if there is nothing on the s_4]Unfortunately, there isn't a thing on it.[end if]".
The bedroom part 15 is some text that varies. The bedroom part 15 is " Oh wow! Is that what I think it is? It is! It's a nightstand. The nightstand is typical.[if there is something on the s_5] On the nightstand you make out [a list of things on the s_5].[end if]".
The bedroom part 16 is some text that varies. The bedroom part 16 is "[if there is nothing on the s_5] But the thing hasn't got anything on it.[end if]".
...
The printed name of s_2 is "desk chair".
Understand "desk chair" as s_2.
...
The printed name of o_0 is "white duvet".
Understand "white duvet" as o_0.
Understand "white" as o_0.
Understand "duvet" as o_0.
