...
The bedroom part 1 is some text that varies. The bedroom part 1 is " wardrobe right there by you.[if c_0 is open and there is something in the c_0] The wardrobe contains [a list of things in the c_0].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " Oh, great. Here's a bed. [if there is something on the s_0]You see [a list of things on the s_0] on the bed. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if there is nothing on the s_0]But the thing is empty.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a dressing table. [if there is something on the s_1]On the dressing table you can make out [a list of things on the s_1].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_1]But the thing is empty. Hm. Oh well[end if]".
...
The printed name of s_1 is "dressing table".
Understand "dressing table" as s_1.
Understand "dressing" as s_1.
...
The printed name of o_0 is "white belt".
Understand "white belt" as o_0.
Understand "white" as o_0.
Understand "belt" as o_0.
