...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. An usual kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'

 You can make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is " shower.[if c_0 is open and there is something in the c_0] The shower contains [a list of things in the c_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The bathroom part 2 is some text that varies. The bathroom part 2 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The shower is empty![end if]".
The bathroom part 3 is some text that varies. The bathroom part 3 is " If you haven't noticed it already, there seems to be something there by the wall, it's a pedal bin.[if c_1 is open and there is something in the c_1] The pedal bin contains [a list of things in the c_1].[end if]".
The bathroom part 4 is some text that varies. The bathroom part 4 is "[if c_1 is open and the c_1 contains nothing] The pedal bin is empty! What a waste of a day![end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a toilet. The toilet is white.[if there is something on the s_0] On the toilet you make out [a list of things on the s_0].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_0] However, the toilet, like an empty toilet, has nothing on it.[end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is " You can make out a sink. The sink is ordinary.[if there is something on the s_1] On the sink you make out [a list of things on the s_1]. Hmmm... what else, what else?[end if]".
The bathroom part 8 is some text that varies. The bathroom part 8 is "[if there is nothing on the s_1] But the thing is empty.[end if]".
The bathroom part 9 is some text that varies. The bathroom part 9 is " You see a bathtub. The bathtub is typical.[if there is something on the s_2] On the bathtub you see [a list of things on the s_2].[end if]".
The bathroom part 10 is some text that varies. The bathroom part 10 is "[if there is nothing on the s_2] But the thing hasn't got anything on it.[end if]".
The bathroom part 11 is some text that varies. The bathroom part 11 is "

".
The description of r_0 is "[bathroom part 0][bathroom part 1][bathroom part 2][bathroom part 3][bathroom part 4][bathroom part 5][bathroom part 6][bathroom part 7][bathroom part 8][bathroom part 9][bathroom part 10][bathroom part 11]".
